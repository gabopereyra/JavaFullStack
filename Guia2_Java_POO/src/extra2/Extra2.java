...
distancia que existe entre los dos puntos que existen en la clase Puntos. Para 
...
public class Extra2 {
    ...
    public static void main(String[] args) {
         PuntosService servicio = new PuntosService();
         Puntos coordenadas = servicio.crearPuntos();
         System.out.println(servicio.calcularDistancia(coordenadas));
    }
