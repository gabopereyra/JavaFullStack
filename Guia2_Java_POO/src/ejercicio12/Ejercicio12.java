...
public class Ejercicio12 {
    ...
    public static void main(String[] args) {
        PersonaService nuevoServicio =  new PersonaService();
        Persona gabo = nuevoServicio.crearPersona();
        System.out.println(gabo.getFechaNacimiento());
         System.out.println(nuevoServicio.calcularEdad(gabo));
         System.out.println(nuevoServicio.menorQue(15, gabo));
